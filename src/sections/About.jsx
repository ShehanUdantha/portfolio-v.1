...
const About = () => {
  return (
    <div className="flex flex-col py-[3rem] px-[20px] w-full dark:bg-[#121212] md:h-screen md:py-[4.5rem] md:flex-row md:px-[14.5rem]">
      ...
      <div className="w-full flex flex-col justify-center items-center md:pl-[3rem]">
        ...
        >
          ...
          Undergraduate who loves front-end development and learning new
        ...
        >
          <button className="flex items-center justify-center gap-1 h-[44px] w-[150px] text-[14px] rounded-md shadow-md  bg-black text-white hover:bg-black/70 dark:bg-white/90 dark:text-black">
            Download CV <HiOutlineDocumentText className="h-[17px] w-[18px]" />
          </button>
        </motion.div>
        <motion.div
          className="w-full hidden justify-start font-[800] text-[18px] text-black dark:text-white/90 pt-[2.5rem] md:flex"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          view={{ once: true, amount: 0.5 }}
        ...
        <div className="flex flex-col items-center w-full text-black/80 pt-[3.5rem] dark:text-[#a7a7a8] md:pt-[0.8rem] md:flex-row">
          ...
          <div className="flex w-full gap-9 justify-center items-center pt-[1.5rem] md:gap-7 md:justify-start md:pt-0 md:pl-[27px]">
            ...
            >
              <FaGithub className="h-[29px] w-[29px] hover:opacity-80" />
            </motion.div>
